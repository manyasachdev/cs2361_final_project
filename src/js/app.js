App = {
  ...
  initContract: function() {
    $.getJSON("./contracts/Election.json", function(election) {
      App.contracts.Election = TruffleContract(election); // Instantiate a new truffle contract from the artifact
      App.contracts.Election.setProvider(App.web3Provider); // Connect provider to interact with contract
    ...
    App.contracts.Election.deployed().then(function(instance) {
      ...
      for (var i = 1; i <= num_candidates; i++) {
        electionInstance.candidates(i).then(function(candidate) {
          ...
          var candidateOption = "<option value='" + "'>" + cname + "</option>" 
